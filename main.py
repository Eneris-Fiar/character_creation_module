...
def start_training(char_name: str, char_class: str) -> str:
    """класс персонажа -> описание класса, трениврока игры."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """имя, класс персонажа -> регистрация."""
    approve_choice: str = ''
    char_class: str = ''
...
def main() -> None:
    ...
    print(start_training(char_name, char_class))def attack(char_name: str, char_class: str) -> str:
    """класс персонажа -> урон."""
    if char_class == 'warrior':
        return f'{char_name} нанёс урон противнику равный {5 + randint(3,5)}'
    elif char_class == 'mage':
